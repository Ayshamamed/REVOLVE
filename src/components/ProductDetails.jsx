      ...
      {productdetails === undefined ? <h1 className='text-center my-3'>Loading...</h1> : <div className="container col-xxl-8 px-4 py-5">
          <div className="row flex-lg-row-reverse align-items-center g-5 py-5 ">
            <div className="col-10 col-sm-8 col-lg-6">
              <img src={productdetails.img} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width={300} height={300} loading="lazy" />
            </div>
            <div className="col-lg-6">
              ...
              <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                ...
                <button type="button" className="btn btn-outline-secondary px-4 me-md-2 fw-bold" style={{borderRadius:"0px"}}>BACK</button>
                </LinkContainer>
